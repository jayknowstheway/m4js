{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 197.0, 171.0, 462.0, 313.0 ],
		"bglocked" : 0,
		"defrect" : [ 197.0, 171.0, 462.0, 313.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 160.0, 109.0, 20.0 ],
					"presentation_rect" : [ 112.0, 143.0, 0.0, 0.0 ],
					"text" : "4.) clear the object"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 145.0, 32.5, 16.0 ],
					"presentation_rect" : [ 81.0, 146.0, 0.0, 0.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 275.0, 239.0, 27.0 ],
					"presentation_rect" : [ 193.0, 273.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 180.0, 71.0, 20.0 ],
					"presentation_rect" : [ 193.0, 194.0, 0.0, 0.0 ],
					"text" : "6.) Confirm"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 295.0, 180.0, 36.0, 16.0 ],
					"presentation_rect" : [ 154.0, 194.0, 0.0, 0.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.0, 135.0, 136.0, 20.0 ],
					"presentation_rect" : [ 187.0, 133.0, 0.0, 0.0 ],
					"text" : "5.) open your JSON file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 215.0, 175.0, 70.0, 18.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 215.0, 155.0, 89.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 215.0, 135.0, 33.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 120.0, 71.0, 18.0 ],
					"text" : "prepend write"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 65.0, 100.0, 88.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 55.0, 361.0, 20.0 ],
					"presentation_rect" : [ 75.0, 56.0, 0.0, 0.0 ],
					"text" : "2.) Confirm it is there. \"dump\" prints everything in the max window"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.0, 80.0, 140.0, 20.0 ],
					"text" : "3.) save it to a JSON file"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 230.0, 204.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 55.0, 36.0, 16.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 10.0, 329.0, 20.0 ],
					"text" : "1.) put some some stuff to populate the \"UI\" object in the JS"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 80.0, 33.0, 16.0 ],
					"text" : "bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 10.0, 36.0, 16.0 ],
					"text" : "bang"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 651.0, 109.0, 322.0, 332.0 ],
						"bglocked" : 0,
						"defrect" : [ 651.0, 109.0, 322.0, 332.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 45.0, 115.0, 27.0, 18.0 ],
									"text" : "rect"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 51.666626, 50.0, 36.0, 16.0 ],
									"text" : "dump"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 160.0, 155.0, 129.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 155.0, 110.0, 29.0, 18.0 ],
									"text" : "type"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 215.0, 92.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 40.0, 180.0, 84.0, 18.0 ],
...
,
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 30.0, 95.0, 59.5, 18.0 ],
									"saved_object_attributes" : 									{
										"embed" : 1
									}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 252.0, 70.0, 20.0 ],
					"text" : "print fromjs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 45.0, 230.0, 123.0, 20.0 ],
